...
static const char *dmenucmd[] = { "dmenu_run", "-c", "-m", dmenumon, "-fn", dmenufont, "-nb", col_base, "-nf", col_ltgray, "-sb", col_red, "-sf", col_black, "-nhb", col_base, "-nhf", col_red, "-shb", col_red, "-shf", col_ltgray, NULL };
